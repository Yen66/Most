...
INITIAL_RATES = (
    ...
    ReferenceRate(
        ...
        date(2024, 10, 28),
        date(2025, 6, 8),
        "пресс-релиз ЦБ РФ от 25.10.2024",
        date(2024, 10, 25),
    ),
    ReferenceRate(
        RateType.KEY_RATE,
        ...
        date(2025, 6, 9),
        date(2025, 7, 27),
        "пресс-релиз ЦБ РФ от 06.06.2025",
        date(2025, 6, 6),
    ),
    ReferenceRate(
        RateType.KEY_RATE,
        ...
        date(2025, 7, 28),
        date(2025, 9, 14),
        "пресс-релиз ЦБ РФ от 25.07.2025",
        date(2025, 7, 25),
    ),
    ReferenceRate(
        RateType.KEY_RATE,
        ...
        date(2025, 9, 15),
        date(2025, 10, 26),
        "пресс-релиз ЦБ РФ от 12.09.2025",
        date(2025, 9, 12),
    ),
    ReferenceRate(
        RateType.KEY_RATE,
        ...
        date(2025, 10, 27),
        date(2025, 12, 21),
        "пресс-релиз ЦБ РФ от 24.10.2025",
        date(2025, 10, 24),
    ),
    ReferenceRate(
        RateType.KEY_RATE,
        ...
        date(2025, 12, 22),
        date(2026, 2, 15),
        "пресс-релиз ЦБ РФ от 19.12.2025",
        date(2025, 12, 19),
    ),
    ReferenceRate(
        RateType.KEY_RATE,
        ...
        date(2026, 2, 16),
        date(2026, 3, 22),
        "пресс-релиз ЦБ РФ от 13.02.2026",
        date(2026, 2, 13),
    ),
    ReferenceRate(
        RateType.KEY_RATE,
        ...
        date(2026, 3, 23),
        date(2026, 4, 26),
        "пресс-релиз ЦБ РФ от 20.03.2026",
        date(2026, 3, 20),
    ),
    ReferenceRate(
        RateType.KEY_RATE,
        ...
        date(2026, 4, 27),
        date(2026, 6, 21),
        "пресс-релиз ЦБ РФ от 24.04.2026",
        date(2026, 4, 24),
    ),
    ReferenceRate(
        RateType.KEY_RATE,
        ...
        date(2026, 6, 22),
        date(2026, 7, 26),
        "пресс-релиз ЦБ РФ от 19.06.2026",
        date(2026, 6, 19),
    ),
    ReferenceRate(
        RateType.KEY_RATE,
        ...
        date(2026, 7, 27),
        None,
        "пресс-релиз ЦБ РФ от 24.07.2026",
        date(2026, 7, 24),
    ),
)
