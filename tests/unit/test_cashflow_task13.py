...
EXPECTED = {
    ...
    "CF3": (42, D("960000"), T("2026-09-20"), T("2026-09-20"), None, D("6720.00"), D("-10000")),
    "CF4": (
        19,
        D("800000"),
        T("2026-10-01"),
...
def test_F1_last_balance_equals_signed_sum(name):
    ...
    signed = sum((f.amount if f.direction == "inflow" else -f.amount for f in flows), D("0"))
